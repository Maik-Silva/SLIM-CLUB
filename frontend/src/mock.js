...
    icon: "Shield"
  } // <--- [CORREÇÃO 1: Faltava a vírgula aqui]
], // <--- Adicionei uma vírgula aqui, caso seja um objeto dentro de um array de mockData
...
      features: [
        "Programa de emagrecimento 28 dias", // <--- [CORREÇÃO 2: Faltava a vírgula aqui]
        "Todos os treinos liberados",
        "Cardápios personalizados",
        "Suporte prioritário",
        "Atualizações semanais",
...
        "Desafios surpresa para manter o processo divertido e empolgante", // <--- Corrigi o erro de digitação "esafios"
...
    "image": "placeholder"
  }
] // <--- [CORREÇÃO 3: Faltava a vírgula aqui]
], // <--- A vírgula anterior resolve o problema de sintaxe.
